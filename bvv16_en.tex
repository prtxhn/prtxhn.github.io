...
\fontspec[BoldFont={PlayfairDisplay-Bold.otf}, ItalicFont={PlayfairDisplay-Italic.otf}]{playfair.otf}
...
% \vspace*{-1.7cm}%
% \hspace*{-1.3cm}%
\includegraphics[width=10cm]{images/blog/small/#2} %
\end{figure}%
}
...
% \hspace*{-2.1cm}%
\vspace*{1cm}%
\includegraphics[width=10cm]{./images/blog/small/#1}
}
% \end{figure}
% \clearpage
}
...
\hspace*{-7cm}%
\vspace*{1cm}%
\includegraphics[width=20cm]{./images/blog/small/#1}
}
\end{figure}
% \clearpage
}
...
\vspace*{-2.7cm}%
\hspace*{-2.1cm}%
\includegraphics[width=\paperwidth]{images/blog/small/#1} %
\end{figure}%
}
...
\abschnitt{Echte {\p} Bürgerbeteiligung\\ statt {\p} \mbox{Pseudopartizipation} \mbox{und Demokratiesimulation}}{natuerlichwurdensiebeteiligtp.png}
